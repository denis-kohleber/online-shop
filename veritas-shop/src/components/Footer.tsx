...
export default function Footer() {
    ...
    const activateDropdown = (
        infoListNumber: number,
        e: React.FocusEvent<Element> | null
    ) => {
        ...
        if (currentRef.current) {
            ...
            if (
                currentRef.current.style.maxHeight !== '0px' &&
                currentRef.current.style.maxHeight !== '' &&
                (e === null ||
                    e.currentTarget.classList.contains('infoHeadline'))
            ) {
        ...
        <footer>
                ...
                <div className="footerMainWrapper">
                    ...
                    >
                        <div className="serviceContainer01 serviceContainer">
                            <figure className="service">
                                <img
                                    ...
                                    alt="Manufactur Icon"
                                />
                                <figcaption className="serviceCaption">
                        ...
                        <div className="serviceContainer02 serviceContainer">
                            <figure className="service">
                                ...
                                />
                                <figcaption className="serviceCaption">
                                    2% Cashback bei Einkäufen im Shop
                                </figcaption>
                            </figure>
                            <figure className="service">
                                <img
                    ...
                    <article className="infoArticle" aria-label="Information">
                        <section className="infoSection">
                            <h2
                                className="infoHeadline infoHeadline01 btn"
                                onClick={() => activateDropdown(1, null)}
                            >
                                Service Hotline
                            </h2>
                            <ul className="infoList" ref={infoList01Ref}>
                                ...
                                <li className="phoneNumber">
                                    <Link
                                        to="/service-hotline"
                                        onFocus={(e) => activateDropdown(1, e)}
                                    >
                                        +49 (0) 0000 / 0000 000
                                    </Link>
                                </li>
                        ...
                        <section className="infoSection">
                            <h2
                                className="infoHeadline infoHeadline02 btn"
                                onClick={() => activateDropdown(2, null)}
                            >
                                Bestellung & Versand
                            </h2>
                            <ul className="infoList" ref={infoList02Ref}>
                                <li>
                                    <Link
                                        to="/delivery"
                                        onFocus={(e) => activateDropdown(2, e)}
                                    >
                        ...
                        <section className="infoSection">
                            <h2
                                className="infoHeadline infoHeadline03 btn"
                                onClick={() => activateDropdown(3, null)}
                            >
                                Informationen
                            </h2>
                            <ul className="infoList" ref={infoList03Ref}>
                                <li>
                                    <Link
                                        to="/jobs"
                                        onFocus={(e) => activateDropdown(3, e)}
                                    >
                                        Stellenangebote
                                    </Link>
                                </li>
                    ...
                    <nav className="footerNav">
                        <ul className="footerLinks">
                            ...
                            <li className="footerLink">
                                <Link to="/cookies">Cookie-Einstellungen</Link>
                            </li>
                        </ul>
                    </nav>
                </div>
            ...
            <section className="devCredit" aria-label="Developer Credit">
                <h2 className="devHeadline">
                    <a
                        className="devLink"
                        href="https://github.com/denis-kohleber"
                    >
                        <img
                ...
                <p className="copyright">
                    © Copyright 2024 Denis Kohleber. All rights reserved.
                </p>
            </section>
        </footer>
    );
